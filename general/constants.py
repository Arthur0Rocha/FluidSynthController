...
MVAVE_REMAP_RANGE = list(range(30,64))
CC_DAMPER = 64
CC_PORTAMENTO_SW = 65
CC_ATTACK = 73
CC_SW1 = 80
...
BASS_DRUM_NOTE = NOTES_DICT['B1']
SNARE_DRUM_NOTE = NOTES_DICT['D2']
SNARE_RING_NOTE = NOTES_DICT['C#2']
CLOSED_HIHAT_NOTE = NOTES_DICT['F#2']
OPEN_HIHAT_NOTE = NOTES_DICT['A#2']
